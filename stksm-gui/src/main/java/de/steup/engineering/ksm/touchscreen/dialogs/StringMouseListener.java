 ...
 * @author sascha
 */
public class StringMouseListener implements MouseListener {
    ...
    public StringMouseListener(Window owner, String title, JTextField field, int minLen, int maxLen, StringSetter setter) {
        this.owner = owner;
        this.title = title;
        this.field = field;
        this.minLen = minLen;
