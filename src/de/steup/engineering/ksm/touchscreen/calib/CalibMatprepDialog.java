 ...
 * @author sascha
 */
public class CalibMatprepDialog extends JDialog {

    private static final long serialVersionUID = -22186225208259673L;

    private final JLabel errorLabel;

    public CalibMatprepDialog(Frame appFrame, String title, final GuiCalibInterface data) {
        ...
        JLabel msgLabel = new JLabel("Bitte warten bis Referenzmaterial in Position.");
