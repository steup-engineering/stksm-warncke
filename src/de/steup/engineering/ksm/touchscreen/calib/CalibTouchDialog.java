 ...
 * @author sascha
 */
public class CalibTouchDialog extends JDialog {

    private static final long serialVersionUID = -2563032320132938984L;
    ...
    public CalibTouchDialog(Frame appFrame, String title, final GuiCalibInterface data) {
        ...
        JLabel msgLabel = new JLabel("Bitte mit dem Antastschalter bis an das Material fahren.");
        ...
        JButton contButton = new JButton("Übernehmen");
